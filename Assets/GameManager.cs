...
public class GameManager : MonoBehaviour
{
    ...
    // Waktu hingga powerup dimunculkan
    public float powerupSpawnMinTine = 7f;
    public float powerupSpawnMaxTime = 15f;

    // Waktu hingga bola api dimunculkan
    public float fireballSpawnMinTine = 5f;
    public float fireballSpawnMaxTime = 7f;
    ...
    private void SetupSpawnPowerup()
    {
        float spawnCountdown = Random.Range(powerupSpawnMinTine, powerupSpawnMaxTime);
        Invoke("SpawnPowerup", spawnCountdown);
    }
    ...
    private void SetupSpawnFireball()
    {
        float spawnCountdown = Random.Range(fireballSpawnMinTine, fireballSpawnMaxTime);
        Invoke("SpawnFireball", spawnCountdown);
    }
